...
I've created an [R Script](R_code/Getting_Started_with_R_script.R) with the code needed for this exercise. Go ahead and open that script now.
...
When creating plots for lab meeting, you could save them as `.png`s, but for publication-quality plots, you really want to save them as `.pdf`s. 

:::{.callout-tip}
### Why save plots as `.pdf`s?
...
I've indicated throughout this document where I've borrowed definitions, examples, etc. from other sources, but the below require special shoutouts:
