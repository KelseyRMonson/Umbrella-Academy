...
Please download and load the packages that we will use today. 

As I noted, you don't need to save the `install.packages()` commands to your actual script since you won't need to run them again. 
