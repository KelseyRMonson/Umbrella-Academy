...
pheatmap(
  ...
  main = "Heatmap of Height and Weight" # Title of the heatmap
)
```
...
pheatmap(
  heatmap_data,
  cluster_rows = TRUE,   # Do cluster rows
...
For example, Padme and Leia are grouped together, as are R2-D2 and R5-D4.

Hmm, that's interesting. Padme and Leia are mother and daughter, and R2-D2 and R5-D4 are both the same kind of (astromech) droid. 
