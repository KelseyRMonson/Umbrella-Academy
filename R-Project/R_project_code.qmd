...
You can use this script as a template/cheat sheet as you build your own script, but the best way to learn to code is to type out the commands yourself to start building your muscle memory 💪
...
This code uses the pipe operator (`%>%`) to chain together operations.

[Pipes](https://www.geeksforgeeks.org/pipe-in-r/) are useful but a bit advanced.
