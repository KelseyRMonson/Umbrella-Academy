...
I've created an [R Script](R_code/Getting_Started_with_R_script.R) with the code needed for this exercise. Go ahead and open that script now, and save it into the R Project directory you just made.
