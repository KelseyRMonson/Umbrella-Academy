...
Remember when I used `table()` to show you that R was treating character variables alphabetically?
...
:::{.callout-tip}
In R, when we want to select just one part of a multi-part variable (like a Data Frame or Tibble), we use the `selection operator`, represented by `$`.
:::
