...
![Navigate to the input folder, select the file, and select "Copy raw file."](assets/Download_Data.png) Then create a folder in your own project directory called `input` and save the file there.
