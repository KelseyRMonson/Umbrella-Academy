...
```{r}
ggplot(filtered_star_wars, aes(x = mass, y = height)) +
  geom_point() +
  ylim(NA, 250) +
  scale_color_viridis(alpha = 0.5, begin = 0, end = 1, option = "D", aesthetics = "color", discrete = TRUE) +
  theme_light() +
...
```{r}
# We will keep our filtered full `starwars` dataset for this one
ggplot(filtered_star_wars, aes(x = mass, y = height, color = species, size = species)) +
  geom_point() +
  ylim(NA, 250) +
  scale_color_viridis(alpha = 0.5, begin = 0, end = 1, option = "D", aesthetics = "color", discrete = TRUE) +
  theme_light() +
