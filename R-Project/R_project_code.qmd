...
# But here is the code you need to reproduce the figure in the exercise:
...
Let's use `geom_bar()` to plot height by species, instead of name.
```{r}
ggplot(
  small_star_wars,
  aes(
  ...
  scale_color_viridis(option = "C", alpha = 0.9, begin = 0.1, end = 0.9, discrete=TRUE)
...
ggplot(
  ...
  geom_bar(stat="identity", position="dodge") +
  scale_fill_viridis(option = "C", alpha = 0.9, begin = 0.1, end = 0.9, discrete=TRUE)
