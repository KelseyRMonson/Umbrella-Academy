...
::: callout-caution
Before we progress, we need to turn off a few RStudio defaults that will make our lives better.
...
If you want, you can *coerce* a data type into another one. Let's say I actually wanted `num` to be an integer:
