...
▶️ Pick your favorite plot from any point during the exercise. 
Copy the code, but now create a variable by creating a name and using the assignment operator `<-` before the `ggplot()` call:
